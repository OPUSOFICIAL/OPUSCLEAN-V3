...
ALTER TABLE IF EXISTS ONLY public.zones DROP CONSTRAINT IF EXISTS zones_site_id_sites_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_zone_id_zones_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_service_id_services_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_rated_by_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_qr_code_point_id_qr_code_points_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_maintenance_plan_equipment_id_maintenance_plan_equi;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_maintenance_checklist_template_id_maintenance_check;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_maintenance_activity_id_maintenance_activities_id_f;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_equipment_id_equipment_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_cleaning_activity_id_cleaning_activities_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_checklist_template_id_checklist_templates_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_cancelled_by_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_orders DROP CONSTRAINT IF EXISTS work_orders_assigned_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_order_comments DROP CONSTRAINT IF EXISTS work_order_comments_work_order_id_work_orders_id_fk;
ALTER TABLE IF EXISTS ONLY public.work_order_comments DROP CONSTRAINT IF EXISTS work_order_comments_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.webhook_configs DROP CONSTRAINT IF EXISTS webhook_configs_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.user_site_assignments DROP CONSTRAINT IF EXISTS user_site_assignments_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.user_site_assignments DROP CONSTRAINT IF EXISTS user_site_assignments_site_id_sites_id_fk;
ALTER TABLE IF EXISTS ONLY public.user_role_assignments DROP CONSTRAINT IF EXISTS user_role_assignments_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.user_role_assignments DROP CONSTRAINT IF EXISTS user_role_assignments_role_id_custom_roles_id_fk;
ALTER TABLE IF EXISTS ONLY public.user_role_assignments DROP CONSTRAINT IF EXISTS user_role_assignments_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.user_allowed_customers DROP CONSTRAINT IF EXISTS user_allowed_customers_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_allowed_customers DROP CONSTRAINT IF EXISTS user_allowed_customers_customer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sla_configs DROP CONSTRAINT IF EXISTS sla_configs_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.sites DROP CONSTRAINT IF EXISTS sites_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.sites DROP CONSTRAINT IF EXISTS sites_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.site_shifts DROP CONSTRAINT IF EXISTS site_shifts_site_id_sites_id_fk;
ALTER TABLE IF EXISTS ONLY public.services DROP CONSTRAINT IF EXISTS services_type_id_service_types_id_fk;
ALTER TABLE IF EXISTS ONLY public.services DROP CONSTRAINT IF EXISTS services_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.services DROP CONSTRAINT IF EXISTS services_category_id_service_categories_id_fk;
ALTER TABLE IF EXISTS ONLY public.service_zones DROP CONSTRAINT IF EXISTS service_zones_zone_id_zones_id_fk;
ALTER TABLE IF EXISTS ONLY public.service_zones DROP CONSTRAINT IF EXISTS service_zones_service_id_services_id_fk;
ALTER TABLE IF EXISTS ONLY public.service_types DROP CONSTRAINT IF EXISTS service_types_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.service_types DROP CONSTRAINT IF EXISTS service_types_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.service_categories DROP CONSTRAINT IF EXISTS service_categories_type_id_service_types_id_fk;
ALTER TABLE IF EXISTS ONLY public.service_categories DROP CONSTRAINT IF EXISTS service_categories_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.role_permissions DROP CONSTRAINT IF EXISTS role_permissions_role_id_custom_roles_id_fk;
ALTER TABLE IF EXISTS ONLY public.qr_code_points DROP CONSTRAINT IF EXISTS qr_code_points_zone_id_zones_id_fk;
ALTER TABLE IF EXISTS ONLY public.qr_code_points DROP CONSTRAINT IF EXISTS qr_code_points_service_id_services_id_fk;
ALTER TABLE IF EXISTS ONLY public.qr_code_points DROP CONSTRAINT IF EXISTS qr_code_points_equipment_id_equipment_id_fk;
ALTER TABLE IF EXISTS ONLY public.public_request_logs DROP CONSTRAINT IF EXISTS public_request_logs_qr_code_point_id_qr_code_points_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_plans DROP CONSTRAINT IF EXISTS maintenance_plans_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_plans DROP CONSTRAINT IF EXISTS maintenance_plans_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_plan_equipments DROP CONSTRAINT IF EXISTS maintenance_plan_equipments_plan_id_maintenance_plans_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_plan_equipments DROP CONSTRAINT IF EXISTS maintenance_plan_equipments_equipment_id_equipment_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_plan_equipments DROP CONSTRAINT IF EXISTS maintenance_plan_equipments_checklist_template_id_maintenance_c;
ALTER TABLE IF EXISTS ONLY public.maintenance_checklist_templates DROP CONSTRAINT IF EXISTS maintenance_checklist_templates_service_id_services_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_checklist_templates DROP CONSTRAINT IF EXISTS maintenance_checklist_templates_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_checklist_templates DROP CONSTRAINT IF EXISTS maintenance_checklist_templates_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_checklist_executions DROP CONSTRAINT IF EXISTS maintenance_checklist_executions_work_order_id_work_orders_id_f;
ALTER TABLE IF EXISTS ONLY public.maintenance_checklist_executions DROP CONSTRAINT IF EXISTS maintenance_checklist_executions_executed_by_user_id_users_id_f;
ALTER TABLE IF EXISTS ONLY public.maintenance_checklist_executions DROP CONSTRAINT IF EXISTS maintenance_checklist_executions_equipment_id_equipment_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_checklist_executions DROP CONSTRAINT IF EXISTS maintenance_checklist_executions_checklist_template_id_maintena;
ALTER TABLE IF EXISTS ONLY public.maintenance_activities DROP CONSTRAINT IF EXISTS maintenance_activities_sla_config_id_sla_configs_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_activities DROP CONSTRAINT IF EXISTS maintenance_activities_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_activities DROP CONSTRAINT IF EXISTS maintenance_activities_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_activities DROP CONSTRAINT IF EXISTS maintenance_activities_checklist_template_id_maintenance_checkl;
ALTER TABLE IF EXISTS ONLY public.maintenance_activities DROP CONSTRAINT IF EXISTS maintenance_activities_assigned_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.equipment DROP CONSTRAINT IF EXISTS equipment_zone_id_zones_id_fk;
ALTER TABLE IF EXISTS ONLY public.equipment_types DROP CONSTRAINT IF EXISTS equipment_types_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.equipment DROP CONSTRAINT IF EXISTS equipment_site_id_sites_id_fk;
ALTER TABLE IF EXISTS ONLY public.equipment DROP CONSTRAINT IF EXISTS equipment_equipment_type_id_equipment_types_id_fk;
ALTER TABLE IF EXISTS ONLY public.equipment DROP CONSTRAINT IF EXISTS equipment_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.equipment DROP CONSTRAINT IF EXISTS equipment_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.dashboard_goals DROP CONSTRAINT IF EXISTS dashboard_goals_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.customers DROP CONSTRAINT IF EXISTS customers_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.customer_counters DROP CONSTRAINT IF EXISTS customer_counters_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.custom_roles DROP CONSTRAINT IF EXISTS custom_roles_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.company_counters DROP CONSTRAINT IF EXISTS company_counters_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.cleaning_activities DROP CONSTRAINT IF EXISTS cleaning_activities_zone_id_zones_id_fk;
ALTER TABLE IF EXISTS ONLY public.cleaning_activities DROP CONSTRAINT IF EXISTS cleaning_activities_sla_config_id_sla_configs_id_fk;
ALTER TABLE IF EXISTS ONLY public.cleaning_activities DROP CONSTRAINT IF EXISTS cleaning_activities_site_id_sites_id_fk;
ALTER TABLE IF EXISTS ONLY public.cleaning_activities DROP CONSTRAINT IF EXISTS cleaning_activities_service_id_services_id_fk;
ALTER TABLE IF EXISTS ONLY public.cleaning_activities DROP CONSTRAINT IF EXISTS cleaning_activities_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.cleaning_activities DROP CONSTRAINT IF EXISTS cleaning_activities_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.cleaning_activities DROP CONSTRAINT IF EXISTS cleaning_activities_checklist_template_id_checklist_templates_i;
ALTER TABLE IF EXISTS ONLY public.checklist_templates DROP CONSTRAINT IF EXISTS checklist_templates_zone_id_zones_id_fk;
ALTER TABLE IF EXISTS ONLY public.checklist_templates DROP CONSTRAINT IF EXISTS checklist_templates_site_id_sites_id_fk;
ALTER TABLE IF EXISTS ONLY public.checklist_templates DROP CONSTRAINT IF EXISTS checklist_templates_service_id_services_id_fk;
ALTER TABLE IF EXISTS ONLY public.checklist_templates DROP CONSTRAINT IF EXISTS checklist_templates_customer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist_templates DROP CONSTRAINT IF EXISTS checklist_templates_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.chat_messages DROP CONSTRAINT IF EXISTS chat_messages_conversation_id_chat_conversations_id_fk;
ALTER TABLE IF EXISTS ONLY public.chat_messages DROP CONSTRAINT IF EXISTS chat_messages_ai_integration_id_ai_integrations_id_fk;
ALTER TABLE IF EXISTS ONLY public.chat_conversations DROP CONSTRAINT IF EXISTS chat_conversations_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.chat_conversations DROP CONSTRAINT IF EXISTS chat_conversations_customer_id_customers_id_fk;
ALTER TABLE IF EXISTS ONLY public.chat_conversations DROP CONSTRAINT IF EXISTS chat_conversations_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.bathroom_counters DROP CONSTRAINT IF EXISTS bathroom_counters_zone_id_zones_id_fk;
ALTER TABLE IF EXISTS ONLY public.bathroom_counter_logs DROP CONSTRAINT IF EXISTS bathroom_counter_logs_work_order_id_work_orders_id_fk;
ALTER TABLE IF EXISTS ONLY public.bathroom_counter_logs DROP CONSTRAINT IF EXISTS bathroom_counter_logs_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.bathroom_counter_logs DROP CONSTRAINT IF EXISTS bathroom_counter_logs_counter_id_bathroom_counters_id_fk;
ALTER TABLE IF EXISTS ONLY public.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.ai_integrations DROP CONSTRAINT IF EXISTS ai_integrations_created_by_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.ai_integrations DROP CONSTRAINT IF EXISTS ai_integrations_company_id_companies_id_fk;
DROP INDEX IF EXISTS public.work_orders_customer_number_unique;
DROP INDEX IF EXISTS public.customers_subdomain_unique;
...
ALTER TABLE IF EXISTS ONLY public.work_order_comments DROP CONSTRAINT IF EXISTS work_order_comments_pkey;
ALTER TABLE IF EXISTS ONLY public.webhook_configs DROP CONSTRAINT IF EXISTS webhook_configs_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_username_unique;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_email_unique;
ALTER TABLE IF EXISTS ONLY public.user_site_assignments DROP CONSTRAINT IF EXISTS user_site_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.user_role_assignments DROP CONSTRAINT IF EXISTS user_role_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.user_allowed_customers DROP CONSTRAINT IF EXISTS user_allowed_customers_user_id_customer_id_key;
ALTER TABLE IF EXISTS ONLY public.user_allowed_customers DROP CONSTRAINT IF EXISTS user_allowed_customers_pkey;
ALTER TABLE IF EXISTS ONLY public.service_zones DROP CONSTRAINT IF EXISTS unique_service_zone;
ALTER TABLE IF EXISTS ONLY public.maintenance_plan_equipments DROP CONSTRAINT IF EXISTS unique_plan_equipment;
ALTER TABLE IF EXISTS ONLY public.sla_configs DROP CONSTRAINT IF EXISTS sla_configs_pkey;
ALTER TABLE IF EXISTS ONLY public.sites DROP CONSTRAINT IF EXISTS sites_pkey;
ALTER TABLE IF EXISTS ONLY public.site_shifts DROP CONSTRAINT IF EXISTS site_shifts_pkey;
...
ALTER TABLE IF EXISTS ONLY public.qr_code_points DROP CONSTRAINT IF EXISTS qr_code_points_pkey;
ALTER TABLE IF EXISTS ONLY public.qr_code_points DROP CONSTRAINT IF EXISTS qr_code_points_code_unique;
ALTER TABLE IF EXISTS ONLY public.public_request_logs DROP CONSTRAINT IF EXISTS public_request_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.maintenance_plans DROP CONSTRAINT IF EXISTS maintenance_plans_pkey;
ALTER TABLE IF EXISTS ONLY public.maintenance_plan_equipments DROP CONSTRAINT IF EXISTS maintenance_plan_equipments_pkey;
ALTER TABLE IF EXISTS ONLY public.maintenance_checklist_templates DROP CONSTRAINT IF EXISTS maintenance_checklist_templates_pkey;
ALTER TABLE IF EXISTS ONLY public.maintenance_checklist_executions DROP CONSTRAINT IF EXISTS maintenance_checklist_executions_pkey;
ALTER TABLE IF EXISTS ONLY public.maintenance_activities DROP CONSTRAINT IF EXISTS maintenance_activities_pkey;
ALTER TABLE IF EXISTS ONLY public.equipment_types DROP CONSTRAINT IF EXISTS equipment_types_pkey;
ALTER TABLE IF EXISTS ONLY public.equipment DROP CONSTRAINT IF EXISTS equipment_serial_number_unique;
ALTER TABLE IF EXISTS ONLY public.equipment DROP CONSTRAINT IF EXISTS equipment_pkey;
ALTER TABLE IF EXISTS ONLY public.dashboard_goals DROP CONSTRAINT IF EXISTS dashboard_goals_pkey;
ALTER TABLE IF EXISTS ONLY public.customers DROP CONSTRAINT IF EXISTS customers_pkey;
ALTER TABLE IF EXISTS ONLY public.customer_counters DROP CONSTRAINT IF EXISTS customer_counters_pkey;
ALTER TABLE IF EXISTS ONLY public.customer_counters DROP CONSTRAINT IF EXISTS customer_counters_customer_key_unique;
ALTER TABLE IF EXISTS ONLY public.custom_roles DROP CONSTRAINT IF EXISTS custom_roles_pkey;
ALTER TABLE IF EXISTS ONLY public.company_counters DROP CONSTRAINT IF EXISTS company_counters_pkey;
ALTER TABLE IF EXISTS ONLY public.companies DROP CONSTRAINT IF EXISTS companies_pkey;
ALTER TABLE IF EXISTS ONLY public.cleaning_activities DROP CONSTRAINT IF EXISTS cleaning_activities_pkey;
...
ALTER TABLE IF EXISTS ONLY public.bathroom_counters DROP CONSTRAINT IF EXISTS bathroom_counters_pkey;
ALTER TABLE IF EXISTS ONLY public.bathroom_counter_logs DROP CONSTRAINT IF EXISTS bathroom_counter_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.ai_integrations DROP CONSTRAINT IF EXISTS ai_integrations_pkey;
...
DROP TABLE IF EXISTS public.user_allowed_customers;
DROP TABLE IF EXISTS public.sla_configs;
DROP TABLE IF EXISTS public.sites;
DROP TABLE IF EXISTS public.site_shifts;
...
DROP TABLE IF EXISTS public.qr_code_points;
DROP TABLE IF EXISTS public.public_request_logs;
DROP TABLE IF EXISTS public.maintenance_plans;
DROP TABLE IF EXISTS public.maintenance_plan_equipments;
DROP TABLE IF EXISTS public.maintenance_checklist_templates;
DROP TABLE IF EXISTS public.maintenance_checklist_executions;
DROP TABLE IF EXISTS public.maintenance_activities;
...
DROP TABLE IF EXISTS public.customer_counters;
DROP TABLE IF EXISTS public.custom_roles;
DROP TABLE IF EXISTS public.company_counters;
DROP TABLE IF EXISTS public.companies;
DROP TABLE IF EXISTS public.cleaning_activities;
DROP TABLE IF EXISTS public.checklist_templates;
DROP TABLE IF EXISTS public.chat_messages;
DROP TABLE IF EXISTS public.chat_conversations;
DROP TABLE IF EXISTS public.bathroom_counters;
DROP TABLE IF EXISTS public.bathroom_counter_logs;
...
--
-- Name: user_allowed_customers; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Data for Name: user_allowed_customers; Type: TABLE DATA; Schema: public; Owner: -
--
...
66a8472a-d4a8-4426-8dab-701a1836d7c1	43	company-admin-default	clean	9a364a0e-793e-408f-bb02-1dc7f9a2ce60	58bb5bfa-1b09-47a6-9f27-7532f231ac8b	ca-1762991303691-e4c3ljasd	\N	checklist-1762991278023-lokBNw9B8q	\N	\N	\N	programada	aberta	media	Emergêncial de limpeza - 1ª/2 (2x ao dia)		\N	Sistema - Cronograma	\N	\N	\N	2025-11-22 08:00:00	2025-11-22 10:00:00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2025-11-12 23:48:24.806007	2025-11-12 23:48:24.806007	\N	\N	\N	cea0f695-2531-4e23-93ad-d41c71294aaf	\N
...
72292e5e-efcb-450f-b3af-b7e4aaf38f04	49	company-admin-default	clean	9a364a0e-793e-408f-bb02-1dc7f9a2ce60	58bb5bfa-1b09-47a6-9f27-7532f231ac8b	ca-1762991303691-e4c3ljasd	\N	checklist-1762991278023-lokBNw9B8q	\N	\N	\N	programada	aberta	media	Emergêncial de limpeza - 2ª/2 (2x ao dia)		\N	Sistema - Cronograma	\N	\N	\N	2025-11-23 20:00:00	2025-11-23 22:00:00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2025-11-12 23:48:24.806007	2025-11-12 23:48:24.806007	\N	\N	\N	cea0f695-2531-4e23-93ad-d41c71294aaf	\N
...
d5666729-4903-4a58-a644-127cd6d88767	59	company-admin-default	clean	9a364a0e-793e-408f-bb02-1dc7f9a2ce60	58bb5bfa-1b09-47a6-9f27-7532f231ac8b	ca-1762991303691-e4c3ljasd	\N	checklist-1762991278023-lokBNw9B8q	\N	\N	\N	programada	aberta	media	Emergêncial de limpeza - 1ª/2 (2x ao dia)		\N	Sistema - Cronograma	\N	\N	\N	2025-11-26 08:00:00	2025-11-26 10:00:00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2025-11-12 23:48:24.806007	2025-11-12 23:48:24.806007	\N	\N	\N	cea0f695-2531-4e23-93ad-d41c71294aaf	\N
...
0288e7db-45bb-4b21-b67c-719adddd5840	65	company-admin-default	clean	9a364a0e-793e-408f-bb02-1dc7f9a2ce60	58bb5bfa-1b09-47a6-9f27-7532f231ac8b	ca-1762991303691-e4c3ljasd	\N	checklist-1762991278023-lokBNw9B8q	\N	\N	\N	programada	aberta	media	Emergêncial de limpeza - 2ª/2 (2x ao dia)		\N	Sistema - Cronograma	\N	\N	\N	2025-11-27 20:00:00	2025-11-27 22:00:00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2025-11-12 23:48:24.806007	2025-11-12 23:48:24.806007	\N	\N	\N	cea0f695-2531-4e23-93ad-d41c71294aaf	\N
...
8b927572-b60f-47f4-80ac-36a6d203d4f4	75	company-admin-default	clean	9a364a0e-793e-408f-bb02-1dc7f9a2ce60	58bb5bfa-1b09-47a6-9f27-7532f231ac8b	ca-1762991303691-e4c3ljasd	\N	checklist-1762991278023-lokBNw9B8q	\N	\N	\N	programada	aberta	media	Emergêncial de limpeza - 1ª/2 (2x ao dia)		\N	Sistema - Cronograma	\N	\N	\N	2025-11-30 08:00:00	2025-11-30 10:00:00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2025-11-12 23:48:24.806007	2025-11-12 23:48:24.806007	\N	\N	\N	cea0f695-2531-4e23-93ad-d41c71294aaf	\N
...
--
-- Name: user_allowed_customers user_allowed_customers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_allowed_customers user_allowed_customers_user_id_customer_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: customers_subdomain_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: checklist_templates checklist_templates_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_allowed_customers user_allowed_customers_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_allowed_customers user_allowed_customers_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
